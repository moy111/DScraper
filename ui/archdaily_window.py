# archdaily_scraper.py
import webbrowser
from PyQt6.QtWidgets import QWidget
from PyQt6.QtCore import QThread, pyqtSignal
from utils.frontend_utils.window_ui import create_common_ui
from utils.scraper_utils import scraper_utils
from web_scraper.archdaily_scraper import ArScraper  # 这里导入你的爬虫代码


# 创建爬虫线程
class ArchdailyScraperThreadClass(QThread):
...
class ArchdailyScraperApp(QWidget):
    ...
    def __init__(self, main_app):
        ...
        self.ui_elements = create_common_ui(
            self, "archdaily", "访问archdaily", self.open_webside, exclude_elements=["district_input", "max_links_input", "city_input"]
        )  # 加载公共 UI 模板

        # 修改 page_label 的文本
        self.ui_elements["page_label"].setText("爬取页数：(每一页18个项目)")
    ...
    def start_scraper(self):
        ...
        scraper_utils.start_scraper(self, ArchdailyScraperThreadClass)
    ...
    def open_webside(self):
        """打开 archdaily 搜索页面"""
        webbrowser.open('https://www.archdaily.cn/')  # 修改为archdaily的网址
