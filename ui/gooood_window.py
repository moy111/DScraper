...
from web_scraper.gooood_scraper import Goooodscraper  # 这里导入你的爬虫代码


# 创建爬虫线程
class GoooodScraperThreadClass(QThread):
...
class GoooodScraperApp(QWidget):
    ...
    def __init__(self, main_app):
        ...
        self.ui_elements = create_common_ui(
            self, "谷德", "访问谷德", self.open_webside, exclude_elements=["district_input", "max_links_input", "city_input"]
        )  # 加载公共 UI 模板
    ...
    def start_scraper(self):
        ...
        started = scraper_utils.start_scraper(self, GoooodScraperThreadClass)
    ...
    def open_webside(self):
        """打开 谷德 搜索页面"""
        webbrowser.open('https://www.gooood.cn/')  # 修改为谷德的网址
